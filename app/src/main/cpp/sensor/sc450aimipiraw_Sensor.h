 ...
 *
 ****************************************************************************/
#ifndef _SC450AIMIPI_SENSOR_H
#define _SC450AIMIPI_SENSOR_H
...
//typedef   unsigned short kal_int16;
...
typedef struct imgsensor_struct {
	...
	kal_bool_c   autoflicker_en;		//record autoflicker enable or disable
	kal_bool_c test_pattern;			//record test pattern mode or not
