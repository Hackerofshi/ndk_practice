...
Drawer::Drawer(int origin_width, int origin_height) : m_origin_width(origin_width),
...
void Drawer::ActivateTexture(GLenum type, GLuint texture, GLenum index, int texture_handler) const {
