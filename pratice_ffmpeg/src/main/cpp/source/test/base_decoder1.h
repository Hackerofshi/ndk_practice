...
class BaseDecoder1: public IDecoder {
...
private:
     ...
     * @param that 当前解码器
     */
    static void Decode(const std::shared_ptr<BaseDecoder1>& that);
...
public:
    BaseDecoder1(JNIEnv *env, jstring path, bool for_synthesizer);
    virtual ~BaseDecoder1();
