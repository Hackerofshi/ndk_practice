...
#ifndef NDK_PRACTICE_BASE_DECODER_H
#define NDK_PRACTICE_BASE_DECODER_H
...
protected:
    ...
    AVPixelFormat video_pixel_format() {
        AVPixelFormat format = m_codec_ctx->pix_fmt;
...
#endif //NDK_PRACTICE_BASE_DECODER_H
